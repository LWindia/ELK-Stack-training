      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 lg:mb-12">
            <h2 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 text-balance mb-4">
              Ready to Start?
            </h2>
          ...
          <div className="bg-white rounded-2xl border-2 border-primary-200 shadow-xl p-8 lg:p-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="text-center p-4 bg-accent-50 rounded-xl">
                <div className="text-2xl lg:text-3xl font-bold text-gray-900 mb-1">₹15,000</div>
                <div className="text-xs text-gray-600">+ Taxes</div>
              </div>
            </div>
            ...
            <div className="text-center mb-8">
              <div className="flex items-center justify-center gap-2 mb-2">
                <span className="text-5xl lg:text-6xl font-bold text-gray-900">₹</span>
                <span className="text-6xl lg:text-7xl font-bold gradient-text">
                  15,000
                </span>
              </div>
              <p className="text-gray-600 text-base">+ Taxes • One-time payment</p>
            </div>

            {/* CTA Button */}
            <a
              href="https://razorpay.me/@username"
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full py-4 lg:py-5 bg-gradient-to-r from-primary-500 via-accent-500 to-highlight-500 text-white text-center rounded-xl font-bold text-lg lg:text-xl hover:shadow-glow-accent transition-all duration-300 hover:scale-[1.02] group"
            >
